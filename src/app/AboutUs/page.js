            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div className={styles.storyImageWrapper}>
                  <Image
                    src="/images/howWeStarted.svg"
                    alt="Nook founding story"
                    width={300}
                    height={200}
                    className={`${styles.storyImage} img-fluid d-block mx-auto mb-2`}
                  />
                </div>
              </div>
              <div className="col-lg-6">
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-12 text-center">
                ...
                <div className={styles.sectionSubtitle}>The principles that guide everything we do</div>
              </div>
            </div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-12 text-center">
                ...
                <div className={styles.sectionSubtitle}>The passionate people behind Nook</div>
              </div>
            </div>
            <div className="row mt-5">
              {[1, 2, 3, 4].map((member) => (

                <div className="col-lg-3 col-md-6 mb-2" key={member}>
                  <div className={styles.teamCard}>
                    <div className={styles.teamImageWrapper}>
                      {
                        member % 2 === 0 ? (
                          <Image
                            src="/images/facespanish.jpg"
